...
# you can use to_bytes, but you must specify the amount of bytes, and
# big or little 'indian'; 'big' stores the most significant bytes first
# 'little' stores the least significant bytes first
